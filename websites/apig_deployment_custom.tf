...
resource "aws_api_gateway_stage" "api_stage" {
  ...
  access_log_settings {
    ...
    format          = "$context.requestId [$context.requestTime] - $context.identity.sourceIp \"$context.httpMethod $context.resourcePath $context.protocol\" $context.identity.user | $context.identity.userAgent | API Key: $context.identity.apiKey | Cognito ID: $context.identity.cognitoIdentityId | Error Message: $context.error.message | Response Type: $context.error.responseType | Integration Error: $context.integrationError | Integration Status: $context.integration.integrationStatus | Request Override Header: $context.requestOverride.header.header_name | Response Override Status: $context.responseOverride.status | AWS WAF Response: $context.wafResponseCode"
  }
